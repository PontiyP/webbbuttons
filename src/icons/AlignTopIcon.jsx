const AlignTopIcon = ({ color = 'currentColor', size = '34px', className=''}) => (
        <svg width={size} height={size} className={className} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect width="30" height="1.25" rx="0.625" transform="matrix(1 0 0 -1 5 6.25)" fill={color}/>
            <rect width="25" height="5" rx="0.5" transform="matrix(0 -1 -1 0 15 32.5)" fill={color}/>
            <rect width="15" height="5" rx="0.5" transform="matrix(0 -1 -1 0 27.5 22.5)" fill={color}/>
        </svg>
        );
